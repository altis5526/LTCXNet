...
if __name__ == "__main__":
    ...
    cRT_output_path = f"C:/research/hc3/experiments/cRT"
    ...
    encoder.model.load_state_dict(torch.load(f"{cRT_output_path}/model_best.pt")['model_state_dict'])
    encoder.model = freeze_model(encoder.model)
