...
if __name__ == "__main__":
    ...
    output_path = f"C:/Users/112062522/Downloads/112062522_whuang/research/hc2/experiments"
    weight_dir = f"C:/Users/112062522/Downloads/112062522_whuang/research/hc2/experiments/exp2/{args.seed}_final_model"
    ...
    for mode, loader in zip(['train', 'val', 'test'], loaders):
        ...
        with open(output_path+'/exp2_test_result.txt', 'a') as file:
            file.write(f"seed: {args.seed} {mode} mAP: {mAP}\n")
            for i, label in enumerate(label_name):
                file.write(f"   {label} mAP: {mAPs[i]}\n")
